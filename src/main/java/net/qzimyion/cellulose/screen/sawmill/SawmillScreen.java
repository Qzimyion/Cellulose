...
public class SawmillScreen extends HandledScreen<SawmillScreenHandler> {
    private static final Identifier TEXTURE = new Identifier( "textures/gui/container/stonecutter/stonecutter.png");
    ...
    protected void drawMouseoverTooltip(DrawContext context, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<SawmillingRecipe> list = ((SawmillScreenHandler)this.handler).getAvailableRecipes();
