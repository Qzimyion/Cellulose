...
public class AppleLeavesParticle extends SpriteBillboardParticle {
    public float field_43369;
    public final float field_43370;
    public final float field_43371;
    public AppleLeavesParticle(ClientWorld world, double x, double y, double z, SpriteProvider spriteProvider) {
        super(world, x, y, z);
        float f;
