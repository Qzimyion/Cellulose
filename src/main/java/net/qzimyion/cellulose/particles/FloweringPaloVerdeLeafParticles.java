...
public class FloweringPaloVerdeLeafParticles extends SpriteBillboardParticle {
    public float field_43369;
    public final float field_43370;
    public final float field_43371;

    public FloweringPaloVerdeLeafParticles(ClientWorld clientWorld, double x, double y, double z, SpriteProvider spriteProvider) {
