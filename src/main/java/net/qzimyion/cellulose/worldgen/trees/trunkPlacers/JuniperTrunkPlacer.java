...
public class JuniperTrunkPlacer extends TrunkPlacer {
    public static final Codec<JuniperTrunkPlacer> CODEC = RecordCodecBuilder.create(instance -> fillTrunkPlacerFields(instance)
            ...
            .forGetter((trunkPlacer) -> trunkPlacer.canGrowThrough))).apply(instance, JuniperTrunkPlacer::new));
    ...
    public JuniperTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight, IntProvider extraBranchSteps, float placeBranchPerLogProbability, IntProvider extraBranchLength, RegistryEntryList<Block> canGrowThrough) {
    ...
    protected TrunkPlacerType<?> getType() {
        return CelluloseTrunkPlacerTypes.JUNIPER_TRUNK_PLACER;
    }
