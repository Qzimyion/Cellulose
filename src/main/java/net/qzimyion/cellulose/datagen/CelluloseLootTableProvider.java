...
public class CelluloseLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        /*Carpented wood*/
        addDrop(CARPENTED_OAK);
        addDrop(CARPENTED_BIRCH);
        addDrop(CARPENTED_SPRUCE);
        addDrop(CARPENTED_DARK_OAK);
        addDrop(CARPENTED_JUNGLE);
        addDrop(CARPENTED_ACACIA);
        addDrop(CARPENTED_CRIMSON);
        addDrop(CARPENTED_WARPED);
        addDrop(CARPENTED_MANGROVE);
        addDrop(CARPENTED_BAMBOO);
        addDrop(CARPENTED_CHERRY);
        addDrop(CARPENTED_CACTUS);
        /*Plank Pillars*/
        ...
        addDrop(VERTICAL_OAK_PLANK_PILLARS);
        addDrop(VERTICAL_BIRCH_PLANK_PILLARS);
        addDrop(VERTICAL_SPRUCE_PLANK_PILLARS);
        addDrop(VERTICAL_DARK_OAK_PLANK_PILLARS);
        addDrop(VERTICAL_JUNGLE_PLANK_PILLARS);
        addDrop(VERTICAL_ACACIA_PLANK_PILLARS);
        addDrop(VERTICAL_CRIMSON_PLANK_PILLARS);
        addDrop(VERTICAL_WARPED_PLANK_PILLARS);
        addDrop(VERTICAL_MANGROVE_PLANK_PILLARS);
        addDrop(VERTICAL_BAMBOO_PLANK_PILLARS);
        addDrop(VERTICAL_CHERRY_PLANK_PILLARS);
        addDrop(VERTICAL_CACTUS_PLANK_PILLARS);
        /*Beams*/
        addDrop(OAK_BEAM);
        addDrop(BIRCH_BEAM);
        addDrop(SPRUCE_BEAM);
        ...
        /*carved*/
        addDrop(OAK_CARVED);
        addDrop(BIRCH_CARVED);
        addDrop(SPRUCE_CARVED);
        addDrop(DARK_OAK_CARVED);
        addDrop(JUNGLE_CARVED);
        addDrop(ACACIA_CARVED);
        addDrop(CRIMSON_CARVED);
        addDrop(WARPED_CARVED);
        addDrop(MANGROVE_CARVED);
        addDrop(BAMBOO_CARVED);
        addDrop(CHERRY_CARVED);
        addDrop(CACTUS_CARVED);
        /*Pavement*/
