...
public class CelluloseEvents {
    ...
    static {
        ...
        //Stair Repairing
        STAIR_REPAIR.put(CHIPPED_OAK_STAIR, OAK_STAIRS);
        STAIR_REPAIR.put(CHIPPED_BIRCH_STAIR, BIRCH_STAIRS);
        STAIR_REPAIR.put(CHIPPED_SPRUCE_STAIR, SPRUCE_STAIRS);
        STAIR_REPAIR.put(CHIPPED_DARK_OAK_STAIR, DARK_OAK_STAIRS);
        STAIR_REPAIR.put(CHIPPED_JUNGLE_STAIR, JUNGLE_STAIRS);
        STAIR_REPAIR.put(CHIPPED_ACACIA_STAIR, ACACIA_STAIRS);
        STAIR_REPAIR.put(CHIPPED_WARPED_STAIR, WARPED_STAIRS);
        STAIR_REPAIR.put(CHIPPED_CRIMSON_STAIR, CRIMSON_STAIRS);
        STAIR_REPAIR.put(CHIPPED_MANGROVE_STAIR, MANGROVE_STAIRS);
        STAIR_REPAIR.put(CHIPPED_BAMBOO_STAIR, BAMBOO_STAIRS);
        STAIR_REPAIR.put(CHIPPED_CHERRY_STAIR, CHERRY_STAIRS);
        STAIR_REPAIR.put(CHIPPED_CACTUS_STAIR, CACTUS_STAIRS);
        STAIR_REPAIR.put(CHIPPED_AZALEA_STAIR, AZALEA_STAIRS);
        STAIR_REPAIR.put(CHIPPED_BLOOMING_AZALEA_STAIR, BLOOMING_AZALEA_STAIRS);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_OAK_STAIR, VERTICAL_OAK_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_BIRCH_STAIR, VERTICAL_BIRCH_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_SPRUCE_STAIR, VERTICAL_SPRUCE_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_DARK_OAK_STAIR, VERTICAL_DARK_OAK_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_JUNGLE_STAIR, VERTICAL_JUNGLE_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_ACACIA_STAIR, VERTICAL_ACACIA_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_WARPED_STAIR, VERTICAL_WARPED_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_CRIMSON_STAIR, VERTICAL_CRIMSON_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_MANGROVE_STAIR, VERTICAL_MANGROVE_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_BAMBOO_STAIR, VERTICAL_BAMBOO_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_CHERRY_STAIR, VERTICAL_CHERRY_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_CACTUS_STAIR, VERTICAL_CACTUS_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_AZALEA_STAIR, VERTICAL_AZALEA_STAIR);
        STAIR_REPAIR.put(CHIPPED_VERTICAL_BLOOMING_AZALEA_STAIR, VERTICAL_BLOOMING_AZALEA_STAIR);
            ...
            if (heldItem.getItem()== Items.BAMBOO_BLOCK){
                if (targetBlock.isOf(WATER_CAULDRON) && (targetBlock.get(LeveledCauldronBlock.LEVEL) == 3)
                    ...
                    if (player instanceof ServerPlayerEntity) {
                        Criteria.ITEM_USED_ON_BLOCK.trigger((ServerPlayerEntity) player, targetPos, heldItem);
                        if (!player.isCreative()) heldItem.decrement(1);
                        world.setBlockState(targetPos, DISSOLVED_BAMBOO_CAULDRON_BLOCK.getDefaultState());
                    }
                }
            }
            //Paper mesh
            if (heldItem.isIn(CelluloseTags.Items.CURING_AGENTS)){
                if (targetBlock.isOf(DISSOLVED_BAMBOO_CAULDRON_BLOCK)){
                    ...
                    if (player instanceof ServerPlayerEntity) {
                        Criteria.ITEM_USED_ON_BLOCK.trigger((ServerPlayerEntity) player, targetPos, heldItem);
                        if (!player.isCreative()) heldItem.decrement(1);
                        world.setBlockState(targetPos, PAPER_MESH_CAULDRON_BLOCK.getDefaultState());
                    }
                }
            }
