        ...
        UseBlockCallback.EVENT.register((player, world, hand, hitResult) -> {
            ...
            if (input != null && output != null) {
                if (state.isOf(input) && heldItem.getItem()==Items.BLAZE_POWDER) {
                    ...
                    ParticleUtil.spawnParticle(world, pos, ParticleTypes.SMOKE, UniformIntProvider.create(1, 3));
                    ParticleUtil.spawnParticle(world, pos, ParticleTypes.SMALL_FLAME, UniformIntProvider.create(1, 2));
