...
public class CelluloseItemGroups
{
    public static void registerItemGroups()
    {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(content -> {
            ...
            content.addAfter(OAK_SLAB, FLIPPED_OAK_PLANKS, FLIPPED_VERTICAL_OAK_PLANKS, VERTICAL_OAK_PLANKS, VERTICAL_OAK_STAIR, VERTICAL_OAK_SLAB);
            content.addAfter(BIRCH_SLAB, VERTICAL_BIRCH_PLANKS, VERTICAL_BIRCH_STAIR, VERTICAL_BIRCH_SLAB);
            content.addAfter(SPRUCE_SLAB, FLIPPED_SPRUCE_PLANKS, FLIPPED_VERTICAL_SPRUCE_PLANKS, VERTICAL_SPRUCE_PLANKS, VERTICAL_SPRUCE_STAIR, VERTICAL_SPRUCE_SLAB);
            content.addAfter(DARK_OAK_SLAB, FLIPPED_DARK_OAK_PLANKS, FLIPPED_VERTICAL_DARK_OAK_PLANKS, VERTICAL_DARK_OAK_PLANKS, VERTICAL_DARK_OAK_STAIR, VERTICAL_DARK_OAK_SLAB);
            content.addAfter(ACACIA_SLAB, FLIPPED_ACACIA_PLANKS, FLIPPED_VERTICAL_ACACIA_PLANKS, VERTICAL_ACACIA_PLANKS, VERTICAL_ACACIA_STAIR, VERTICAL_ACACIA_SLAB);
            content.addAfter(JUNGLE_SLAB, FLIPPED_JUNGLE_PLANKS, FLIPPED_VERTICAL_JUNGLE_PLANKS, VERTICAL_JUNGLE_PLANKS, VERTICAL_JUNGLE_STAIR, VERTICAL_JUNGLE_SLAB);
            content.addAfter(CRIMSON_SLAB, FLIPPED_CHERRY_PLANKS, FLIPPED_VERTICAL_CHERRY_PLANKS, VERTICAL_CRIMSON_PLANKS, VERTICAL_CRIMSON_STAIR, VERTICAL_CRIMSON_SLAB);
            content.addAfter(WARPED_SLAB, FLIPPED_WARPED_PLANKS, FLIPPED_VERTICAL_WARPED_PLANKS, VERTICAL_WARPED_PLANKS, VERTICAL_WARPED_STAIR, VERTICAL_WARPED_SLAB);
            content.addAfter(MANGROVE_SLAB, FLIPPED_MANGROVE_PLANKS, FLIPPED_VERTICAL_MANGROVE_PLANKS, VERTICAL_MANGROVE_PLANKS, VERTICAL_MANGROVE_STAIR, VERTICAL_MANGROVE_SLAB);
            content.addAfter(BAMBOO_SLAB, FLIPPED_BAMBOO_PLANKS, FLIPPED_VERTICAL_BAMBOO_PLANKS, VERTICAL_BAMBOO_PLANKS, VERTICAL_BAMBOO_STAIR, VERTICAL_BAMBOO_SLAB);
            content.addAfter(CHERRY_SLAB, FLIPPED_CHERRY_PLANKS, FLIPPED_VERTICAL_CHERRY_PLANKS, VERTICAL_CHERRY_PLANKS, VERTICAL_CHERRY_STAIR, VERTICAL_CHERRY_SLAB);
            ...
            content.addAfter(OAK_LINTELS, OAK_PLANK_PAVEMENT);
            content.addAfter(BIRCH_LINTELS, BIRCH_PLANK_PAVEMENT);
            content.addAfter(SPRUCE_LINTELS, SPRUCE_PLANK_PAVEMENT);
            content.addAfter(DARK_OAK_LINTELS, DARK_OAK_PLANK_PAVEMENT);
            content.addAfter(JUNGLE_LINTELS, JUNGLE_PLANK_PAVEMENT);
            content.addAfter(ACACIA_LINTELS, ACACIA_PLANK_PAVEMENT);
            content.addAfter(CRIMSON_LINTELS, CRIMSON_PLANK_PAVEMENT);
            content.addAfter(WARPED_LINTELS, WARPED_PLANK_PAVEMENT);
            content.addAfter(MANGROVE_LINTELS, MANGROVE_PLANK_PAVEMENT);
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(content -> content.addAfter(WARPED_BUTTON, CACTUS_BUNDLE, CACTUS_CROWN, STRIPPED_CACTUS, STRIPPED_CACTUS_CROWN, ENGRAVED_CACTUS, ENGRAVED_CACTUS_CROWN,
                CACTUS_MOSAIC, CACTUS_MOSAIC_STAIRS, CACTUS_MOSAIC_SLABS, CACTUS_PLANKS, CACTUS_STAIRS, CACTUS_SLAB, FLIPPED_CACTUS_PLANKS, FLIPPED_VERTICAL_CACTUS_PLANKS, VERTICAL_CACTUS_PLANKS, VERTICAL_CACTUS_STAIR,
                VERTICAL_CACTUS_SLAB, CACTUS_FENCE, CACTUS_FENCE_GATE, CACTUS_DOOR, CACTUS_TRAPDOOR, CACTUS_PRESSURE_PLATE, CACTUS_BUTTON
        ));

        //Azalea woodset
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(content -> content.addAfter(CACTUS_BUTTON, AZALEA_LOG, AZALEA_WOOD, STRIPPED_AZALEA, STRIPPED_AZALEA_WOOD, ENGRAVED_AZALEA, ENGRAVED_AZALEA_WOOD,
                ...
                BLOOMING_AZALEA_STAIRS, BLOOMING_AZALEA_SLAB, FLIPPED_AZALEA_PLANKS, FLIPPED_BLOOMING_AZALEA_PLANKS, FLIPPED_VERTICAL_AZALEA_PLANKS, FLIPPED_VERTICAL_BLOOMING_AZALEA_PLANKS, VERTICAL_AZALEA_PLANKS, VERTICAL_AZALEA_STAIR,
                VERTICAL_AZALEA_SLAB, VERTICAL_BLOOMING_AZALEA_PLANKS, VERTICAL_BLOOMING_AZALEA_STAIR, VERTICAL_BLOOMING_AZALEA_SLAB, AZALEA_FENCE, AZALEA_FENCE_GATE, AZALEA_DOOR, BLOOMING_AZALEA_DOOR, AZALEA_TRAPDOOR, BLOOMING_AZALEA_TRAPDOOR,
