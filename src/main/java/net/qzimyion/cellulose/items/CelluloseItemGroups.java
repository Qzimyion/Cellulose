...
public class CelluloseItemGroups
{
    public static void registerItemGroups()
    {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.BUILDING_BLOCKS).register(content -> {
            ...
            content.addAfter(BIRCH_DOOR, BIRCH_BOOKSHELF, ABANDONED_BIRCH_BOOKSHELF, COBWEBBED_BIRCH_BOOKSHELF, EMPTY_BIRCH_BOOKSHELF, COBWEBBED_EMPTY_BIRCH_BOOKSHELF);
            content.addAfter(SPRUCE_DOOR, SPRUCE_BOOKSHELF, ABANDONED_SPRUCE_BOOKSHELF, COBWEBBED_SPRUCE_BOOKSHELF, EMPTY_SPRUCE_BOOKSHELF, COBWEBBED_EMPTY_SPRUCE_BOOKSHELF);
            content.addAfter(DARK_OAK_DOOR, DARK_OAK_BOOKSHELF, ABANDONED_DARK_OAK_BOOKSHELF, COBWEBBED_DARK_OAK_BOOKSHELF, EMPTY_DARK_OAK_BOOKSHELF, COBWEBBED_EMPTY_DARK_OAK_BOOKSHELF);
            content.addAfter(JUNGLE_DOOR, JUNGLE_BOOKSHELF, ABANDONED_JUNGLE_BOOKSHELF, COBWEBBED_JUNGLE_BOOKSHELF, EMPTY_JUNGLE_BOOKSHELF, COBWEBBED_EMPTY_JUNGLE_BOOKSHELF);
            content.addAfter(ACACIA_DOOR, ACACIA_BOOKSHELF, ABANDONED_ACACIA_BOOKSHELF, COBWEBBED_ACACIA_BOOKSHELF, EMPTY_ACACIA_BOOKSHELF, COBWEBBED_EMPTY_ACACIA_BOOKSHELF);
            content.addAfter(CRIMSON_DOOR, CRIMSON_BOOKSHELF, ABANDONED_CRIMSON_BOOKSHELF, COBWEBBED_CRIMSON_BOOKSHELF, EMPTY_CRIMSON_BOOKSHELF, COBWEBBED_EMPTY_CRIMSON_BOOKSHELF);
            content.addAfter(WARPED_DOOR, WARPED_BOOKSHELF, ABANDONED_WARPED_BOOKSHELF, COBWEBBED_WARPED_BOOKSHELF, EMPTY_WARPED_BOOKSHELF, COBWEBBED_EMPTY_WARPED_BOOKSHELF);
            content.addAfter(MANGROVE_DOOR, MANGROVE_BOOKSHELF, ABANDONED_MANGROVE_BOOKSHELF, COBWEBBED_MANGROVE_BOOKSHELF, EMPTY_MANGROVE_BOOKSHELF, COBWEBBED_EMPTY_MANGROVE_BOOKSHELF);
            content.addAfter(BAMBOO_DOOR, BAMBOO_BOOKSHELF, ABANDONED_BAMBOO_BOOKSHELF, COBWEBBED_BAMBOO_BOOKSHELF, EMPTY_BAMBOO_BOOKSHELF, COBWEBBED_EMPTY_BAMBOO_BOOKSHELF);
            content.addAfter(CHERRY_DOOR, CHERRY_BOOKSHELF, ABANDONED_CHERRY_BOOKSHELF, COBWEBBED_CHERRY_BOOKSHELF, EMPTY_CHERRY_BOOKSHELF, COBWEBBED_EMPTY_CHERRY_BOOKSHELF);
            content.addAfter(CACTUS_DOOR, CACTUS_BOOKSHELF, ABANDONED_CACTUS_BOOKSHELF, COBWEBBED_CACTUS_BOOKSHELF, EMPTY_CACTUS_BOOKSHELF, COBWEBBED_EMPTY_CACTUS_BOOKSHELF);
            content.addAfter(AZALEA_DOOR, AZALEA_BOOKSHELF, ABANDONED_AZALEA_BOOKSHELF, COBWEBBED_AZALEA_BOOKSHELF, EMPTY_AZALEA_BOOKSHELF, COBWEBBED_EMPTY_AZALEA_BOOKSHELF);
        });
