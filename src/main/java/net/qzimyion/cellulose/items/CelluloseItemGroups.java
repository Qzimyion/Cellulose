...
public class CelluloseItemGroups
{
    public static void registerItemGroups()
    {
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.BUILDING_BLOCKS).register(content -> {
            ...
            content.addAfter(OAK_PLANK_PAVEMENT, OAK_TIMBERS, OAK_TIMBERS_STAIRS, OAK_TIMBERS_SLABS, OAK_BOARDS, OAK_TILES_STAIRS, OAK_TILES_SLABS, OAK_GLAZED, GLAZED_OAK_STAIRS, GLAZED_OAK_SLABS, CHISELED_OAK);
        ...
        ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.BUILDING_BLOCKS).register(content -> content.addAfter(CACTUS_BUTTON, AZALEA_LOG, AZALEA_WOOD, STRIPPED_AZALEA_LOG, STRIPPED_AZALEA_WOOD, ENGRAVED_AZALEA, ENGRAVED_AZALEA_WOOD,
                AZALEA_MOSAIC, AZALEA_MOSAIC_STAIRS, AZALEA_MOSAIC_SLABS, AZALEA_PLANKS, AZALEA_STAIRS, AZALEA_SLAB, VERTICAL_AZALEA_PLANKS, VERTICAL_AZALEA_STAIR, VERTICAL_AZALEA_SLAB, AZALEA_FENCE, AZALEA_FENCE_GATE, AZALEA_DOOR, AZALEA_TRAPDOOR, AZALEA_PRESSURE_PLATE, AZALEA_BUTTON
        ));
    }
