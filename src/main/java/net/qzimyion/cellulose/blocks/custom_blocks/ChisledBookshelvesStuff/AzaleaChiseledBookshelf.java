...
public class AzaleaChiseledBookshelf extends BlockWithEntity {
    ...
    public AzaleaChiseledBookshelf(Settings settings) {
        super(settings);
    ...
    private static void tryAddBook(World world, BlockPos pos, PlayerEntity player, AzaleaChiseldBookshelfBlockEntity blockEntity, ItemStack stack, int slot){
        if (world.isClient) {
            return;
        }
    ...
    private static void tryRemoveBook(World world, BlockPos pos, PlayerEntity player, AzaleaChiseldBookshelfBlockEntity blockEntity, int slot){
        if (world.isClient) {
            return;
        }
