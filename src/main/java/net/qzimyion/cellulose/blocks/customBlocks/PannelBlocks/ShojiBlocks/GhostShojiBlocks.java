...
public class GhostShojiBlocks extends Block implements Waterloggable {
    ...
    public GhostShojiBlocks(Settings settings) {
        super(settings);
    ...
    public BlockState getConnection(BlockState state, WorldAccess world, BlockPos pos){
        ...
        boolean sideU = (bottom.getBlock() instanceof GhostShojiBlocks && (bottom.get(FACING)==facing));
        boolean sideD = (top.getBlock() instanceof GhostShojiBlocks && (top.get(FACING)==facing));
